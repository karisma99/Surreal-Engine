...
void World::KeyPressed(AZUL_KEY k)
{
	switch (k)
	{
...
void World::KeyReleased(AZUL_KEY k)
{
	switch (k)
	{
	case AZUL_KEY::KEY_SPACE:
...
void World::CreateSkybox(float scale)
{
	...
	pGObj_Skybox = new GraphicsObject_TextureFlat(pSkyboxModel, ShaderManager::Get("Flat"), TextureManager::Get("skybox"));
